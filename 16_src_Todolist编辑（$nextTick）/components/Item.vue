<template>
    <li>
        <label>
            ...
            这里修改了从List修改过来的props，这里的不允许改是浅层次，就是如果props是一个对象则这个对象的某一个属性哦vue是
...
export default{
    ...
    methods:{
        ...
        handleEdit(todo){
            ...
            //自动获取焦点
            //this.$refs.inputTitle.focus();  //此时你这行代码执行了。但注意vue并没有重新解析模板（input并没有出现在页面上，dom节点并没有被更新），它一定要等这个回调函数执行完之后才会重新去渲染模板
            //使用nextTicket来解决
